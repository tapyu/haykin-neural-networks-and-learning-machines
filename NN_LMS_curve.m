function mse = NN_LMS_curve(dist) 
% Exp 1: Classificaiton using Least Mean Square
...
num_train_min = 3000; % number of minimum training
epochs = 50;
fprintf('Least Mean Square for Classification\n');
...
mu = 0.1;
I = eye(num_in);
w = rand(num_in,1)./2  - 0.25; % Initial weights
...
st = cputime;
fprintf('Calculating weights using LMS ...\n');
fprintf('  ------------------------------------\n');
...
% %figure;
% h = plot(mse,'k');
% %title(['Learning curve for d = ', num2str(dist)]);
...
% 
% %%============================== Testing ==================================
% fprintf('Testing the classifier using LMS ...\n');
% for i = 1 : num_te,
% %for i = num_tr+1:num_samp,
...
% end
% xlabel('x');ylabel('y');
% title(['Classification using LMS with dist = ',num2str(dist), ...
